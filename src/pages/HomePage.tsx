...
<img className="object-cover w-full h-40 rounded-t-2xl" src="/images/2.png" alt="Event Image"/>
  ...
  <a href="/events" className="block px-3 py-1 mt-2 w-28 text-sm text-center text-white bg-blue-600 rounded-lg transition duration-300 hover:bg-blue-700">Register Now</a>
</div>
