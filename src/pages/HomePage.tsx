...
<img className="object-cover w-full h-48 rounded-2xl" src="/images/2.png" alt="Event Image"/>
  ...
  <a href="/events" className="block justify-center items-center px-3 py-1 mt-2 ml-28 w-28 text-sm text-center text-white bg-blue-600 rounded-lg transition duration-300 align-center hover:bg-blue-700">Register Now</a>
</div>
